...
namespace API.Migrations
{
    ...
    [Migration("20220611204501_EsperoQueUltima")]
    partial class EsperoQueUltima
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.src.Domain.ScheduledVisits.Entities.ValueObject.ScheduledVisitsObject", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.src.Domain.User.AgentDocument", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("CRECIID")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("API.src.Domain.User.AgentDocumentImage", b =>
                {
                    b.Property<int?>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AgentDocumentsImages");
                });
            ...
            modelBuilder.Entity("API.src.Domain.Announcement.Entities.AnnouncementAggregate", b =>
                {
                    ...
                    b.HasOne("API.src.Domain.Monetary.Entities.AnnouncementRentMonetary", "RentValues")
                        .WithOne("aggregate")
                        .HasForeignKey("API.src.Domain.Announcement.Entities.AnnouncementAggregate", "AnnouncementRentId");

                    b.HasOne("API.src.Domain.Monetary.Entities.AnnouncementSellMonetary", "SellValues")
                        .WithOne("aggregate")
                    ...
                    b.Navigation("RentValues");

                    b.Navigation("SellValues");
                });
            ...
            modelBuilder.Entity("API.src.Domain.User.AgentDocument", b =>
                {
                    ...
                    b.HasOne("API.src.Domain.User.AgentDocumentImage", "image")
                        .WithMany()
